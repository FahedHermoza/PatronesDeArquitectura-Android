...
import com.fahedhermoza.developer.examplenote01.di.Injection
...
class DetailNotesActivityFragment : Fragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //viewModel = ViewModelProvider(this, ViewModelFactory(NoteRepositoryImpl())).get(DetailNotesViewModel::class.java)
        viewModel = ViewModelProvider(this, Injection.providerDetailNoteViewModelFactory()).get(DetailNotesViewModel::class.java)
