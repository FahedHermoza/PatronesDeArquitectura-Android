...
class NotesActivityFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        //viewModel = ViewModelProvider(this, ViewModelFactory(NoteRepositoryImpl())).get(NotesViewModel::class.java)
        viewModel = ViewModelProvider(this, Injection.providerNoteViewModelFactory()).get(NotesViewModel::class.java)
